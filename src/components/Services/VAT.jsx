  ...
  return (
    <div className='flex justify-center w-full'>
        <div className='pt-4 max-w-800px w-[70%] max-md:w-[90%] flex flex-col gap-4 flex-wrap mb-16'>
            <div className='mb-8'>
                <h2 className='text-buttonBlue font-bold text-5xl mb-8 max-sm:text-4xl' ref={headRef}>Value Added Tax (VAT)</h2>
                <ul className='text-text text-xl list-none ml-2 flex flex-col gap-2' ref={listRef}>
                    <li className='flex gap-4 items-center'>
                            ...
                            </span>Getting Sales Tax Registration under Central Sales Tax Act and MVAT.</li>
                    <li className='flex gap-4 items-center'>
                            <span>
                                <div className='flex flex-col justify-center items-start mt-3 gap-[6px] mb-3'>
                                <span className='block h-[1px] w-8 bg-customBlack'></span>
                            ...
                            </span>Consultancy on matters related to Sales Tax including Tax planning.</li>
                    <li className='flex gap-4 items-center'>
                            <span>
                                <div className='flex flex-col justify-center items-start mt-3 gap-[6px] mb-3'>
                                <span className='block h-[1px] w-8 bg-customBlack'></span>
                            ...
                            </span>Preparation of VAT (Value Added Tax) returns.</li>
                    <li className='flex gap-4 items-center'>
                            <span>
                                <div className='flex flex-col justify-center items-start mt-3 gap-[6px] mb-3'>
                                <span className='block h-[1px] w-8 bg-customBlack'></span>
                            ...
                            </span>Filing of Electronic/Manual VAT returns.</li>
                    <li className='flex gap-4 items-center'>
                            <span>
                                <div className='flex flex-col justify-center items-start mt-3 gap-[6px] mb-3'>
                                <span className='block h-[1px] w-8 bg-customBlack'></span>
                            ...
                            </span>Help in obtaining statutory forms.</li>
                    <li className='flex gap-4 items-center'>
                            <span>
                                <div className='flex flex-col justify-center items-start mt-3 gap-[6px] mb-3'>
                                <span className='block h-[1px] w-8 bg-customBlack'></span>
                            ...
                            </span>Liaison with VAT authorities.</li>
                    <li className='flex gap-4 items-center'>
                            <span>
                                <div className='flex flex-col justify-center items-start mt-3 gap-[6px] mb-3'>
                                <span className='block h-[1px] w-8 bg-customBlack'></span>
                            ...
                            </span>Getting Sales Tax Assessments done.</li>
                    <li className='flex gap-4 items-center'>
                            <span>
                                <div className='flex flex-col justify-center items-start mt-3 gap-[6px] mb-3'>
                                <span className='block h-[1px] w-8 bg-customBlack'></span>
                    ...
                    <li className='flex gap-4 items-center'>
                            ...
                            </span>Consultancy on matters related to Maharashtra Value Added Tax.</li>
                    <li className='flex gap-4 items-center'>
                            <span>
                                <div className='flex flex-col justify-center items-start mt-3 gap-[6px] mb-3'>
                                <span className='block h-[1px] w-8 bg-customBlack'></span>
