        ...
        <div className='max-w-800px w-[80%] flex justify-evenly items-center gap-10 max-lg:flex-col max-lg:items-start text-text'>
            ...
            <div className='flex flex-col w-1/3 max-lg:w-full'>
                ...
                <ul className='flex flex-col gap-2 ml-4'>
                    <Link to='/services/value-added-tax(vat)'><li>Value Added Tax (VAT)</li></Link>
                    <Link to='/services/service-tax'><li>Service Tax</li></Link>
                    <Link to='/services/corporate-services'><li>Corporate Services</li></Link>
                    <Link to='/services/audit'><li>Audit</li></Link>
                </ul>
            </div>
        </div>
    </div>
