    ...
    <div className='text-white relative p-6 pt-24 pb-12'>
      <div className="pt-4 flex gap-4 flex-wrap justify-evenly items-center xl:flex-row mt-[10%]">
          <div className='flex flex-col items-center justify-center gap-12 max-md:order-2'>
              <h1 className='relative h1 text-center font-semibold text-5xl max-sm:text-4xl leading-4rem z-20'>Discover <br /><span className='text-6xl max-sm:text-5xl text-discover font-bold text-shadow-glow'> Jain Jakhotiya & Associates</span></h1>
