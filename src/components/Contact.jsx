...
const Contact = () => {
  return (
    <div className='flex justify-center w-full'>
        <div className='pt-4 max-w-800px w-[70%] flex flex-col gap-4 flex-wrap mb-12'>
            <div className="flex justify-between mr-10 ml-10 max-lg:flex-col max-lg:ml-0 max-lg:mr-0 max-lg:gap-2">
                <div className='flex flex-col gap-2'>
                    <p className='text-h2 text-5xl font-bold'>Contact Us</p>
                </div>
                <div>
                    <div className='flex flex-col gap-2 mb-6'>
                        <p className='text-text text-xl font-bold'>Head Office:</p>
                    ...
                    <div className='flex flex-col gap-2 mb-6'>
                        <p className='text-text text-xl font-bold'>Branch Office:</p>
                        <ul className='text-text text-lg list-none'>
                    ...
                    <div className='flex flex-col gap-2 mb-6'>
                        <p className='text-text text-xl font-bold'>City Office:</p>
                        <ul className='text-text text-lg list-none'>
                    ...
                    <div className='flex flex-col gap-2 mb-8'>
                        <p className='text-text text-xl font-bold mt-8'>Mail</p>
                        <ul className='text-text text-lg list-none'>
                    ...
                    <hr />
                    <div className='flex flex-col gap-2 mb-8'>
                        <p className='text-text text-xl font-bold mt-8'>Phone</p>
                        <ul className='text-text text-lg list-none'>
