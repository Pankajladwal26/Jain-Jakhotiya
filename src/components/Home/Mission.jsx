...
const Mission = () => {
  ...
  return (
    <div 
        ...
        ref={divRef}
    >
        <div className='max-w-800px w-[80%] max-md:w-[90%] flex flex-col gap-4 max-sm:gap-0 items-center justify-end'>
            <div className='flex flex-col items-center justify-center gap-8 max-sm:gap-4 mt-20' ref={headRef}>
            ...
            <div className='flex justify-center flex-col items-end max-md:items-start w-full mb-28'>
                <div className='max-xl:order-2 pt-4 pl-6 flex flex-col items-end justify-end gap-4 flex-wrap mb-6 max-xl:mb-10'>
                    <div className='grid grid-cols-2 gap-10 max-md:grid-cols-1 max-md:gap-8 max-sm:gap-4' ref={gridRef}>
                        <div>
                            ...
                            <p className="text-customBlack text-lg">Delivering excellence in every interaction.</p>
                        </div>
                        <div>
                            ...
                            <p className="text-customBlack text-lg">Upholding the highest standards of integrity and honesty.</p>
                        </div>
                        <div>
                            ...
                            <p className="text-customBlack text-lg">Fostering trust and collaboration.</p>
                        </div>
                        <div>
                            ...
                            <p className="text-customBlack text-lg">Valuing and supporting our team.</p>
                        </div>
                    </div>
                </div>
            </div>
