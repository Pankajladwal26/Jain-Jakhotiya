  ...
  return (
    <div className='flex justify-center items-center w-full'>
        <div className='pt-4 max-w-800px w-[70%] max-md:w-[90%] flex flex-col items-center gap-4 flex-wrap mb-16'>
            ...
            <p className='text-lg text-center text-text'><span className='text-xl font-semibold'>Established in 2014, Jain Jakhotiya & Associates,</span> is a premier firm of Chartered Accountants dedicated to delivering exceptional
